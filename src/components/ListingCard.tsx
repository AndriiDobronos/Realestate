...
const ListingCard = ({ listing, scrollY, onSaveScroll }: ListingCardProps) => {
    const { language } = useLanguage();
    const c = (language === 'en' ? allEnTexts : allUaTexts).cards;
    ...
    return (
        <li className="group flex flex-col bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="flex flex-col flex-1 p-4 gap-3">
                ...
                >
                    <button
                        type="button"
                        className="w-full mt-1 py-2 rounded-xl bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white text-sm font-semibold transition-colors duration-200"
                    >
                        {c[19].text}
                    </button>
                </Link>
