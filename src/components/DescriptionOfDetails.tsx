                                ...
                                <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-0.5">
                                    {filterNullListings.map((_, i) => (
                                        <button
                                            ...
                                            className="!p-2 !min-h-0 !bg-transparent !shadow-none !border-0 flex items-center justify-center"
                                        >
                                            <span className={`block w-2 h-2 rounded-full transition-colors ${i === imgIndex ? 'bg-white' : 'bg-white/45'}`} />
                                        </button>
                                    ))}
                                </div>
                            </>
